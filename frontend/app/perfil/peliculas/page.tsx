  ...
  return (
    <main className="min-h-screen bg-[#14181c] text-white font-sans">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <h1 className="text-2xl font-extrabold mb-6">Mis películas vistas</h1>

        {!logueado ? (
          <p className="text-gray-400 text-sm">
            <Link href="/login" className="underline text-blue-400">Inicia sesión</Link> para ver tus películas.
          </p>
        ) : peliculas.length === 0 ? (
          <p className="text-gray-500 text-sm">Aún no has marcado ninguna película como vista.</p>
        ) : (
